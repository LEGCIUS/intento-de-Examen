...
public class ExamenFinal {
    ...
    public static void menu() throws IOException, NumberFormatException {
        ...
        System.out.println("Nota: Las preguntas estan en el paquete preguntasteoria"
                + " con su puntaje respectivo.");
        System.out.println("Total puntos examen: 25pts( Código) "
                + "y 12pts (Téoria) para untotal de 37 pts\n");
